...
2. Buka menu **Files** di Winbox, lalu drag & drop berkas script berikut:
   ...
   * `mikrotik_vpn_setup.rsc` *(Hanya jika deploy di VPS)*
...
4. **Khusus Skenario VPS / Remote Router**:
   ...
   ```
   *(Pastikan data IP Public VPS, Username, Password, dan IPsec Secret di dalam file tersebut sudah disesuaikan).*
